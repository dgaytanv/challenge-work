#!/bin/bash
# Evaluate i-lat32-s22 two ways, from a fresh clone of the code that builds it.
#
...
CKPT="$HERE/rt_i6_lat32_s22_encoder_20260904_041601.pth"
sha256sum -c "$HERE/rt_i6_lat32_s22_encoder_20260904_041601.pth.sha256" 2>/dev/null || true
