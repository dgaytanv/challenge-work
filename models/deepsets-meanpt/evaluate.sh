#!/bin/bash
# Evaluate deepsets-meanpt two ways, from a fresh clone of the code that builds it.
#
...
echo "== cloning submission-deepsets-meanpt @ 791c450"
git clone -q --branch submission-deepsets-meanpt "$REPO" "$WORK/repo"
cd "$WORK/repo"
git checkout -q 791c450

CKPT="$HERE/rt_d_deepsets_aug_meanpt_encoder_20260903_214738.pth"
sha256sum -c "$HERE/rt_d_deepsets_aug_meanpt_encoder_20260903_214738.pth.sha256" 2>/dev/null || true
