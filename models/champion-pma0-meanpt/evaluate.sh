#!/bin/bash
# Evaluate champion-pma0-meanpt two ways, from a fresh clone of the code that builds it.
#
...
echo "== cloning submission-pma0-meanpt @ 41d45a9"
git clone -q --branch submission-pma0-meanpt "$REPO" "$WORK/repo"
cd "$WORK/repo"
git checkout -q 41d45a9

CKPT="$HERE/rt_d_pma0_aug_meanpt_encoder_20260903_221125.pth"
sha256sum -c "$HERE/rt_d_pma0_aug_meanpt_encoder_20260903_221125.pth.sha256" 2>/dev/null || true
