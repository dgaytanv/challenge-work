...
# 10 "/tools/Xilinx/Vitis/2024.2/common/technology/autopilot/ap_fixed.h" 2
...
# 11 "/tools/Xilinx/Vitis/2024.2/common/technology/autopilot/ap_int.h"
...
__attribute__((sdx_kernel("topf", 0))) void topf(T a[8], T w[8], T &y){
#line 7 "/home/jovyan/c2-g/synth/lictest/t.tcl"
#pragma HLSDIRECTIVE TOP name=topf
# 3 "t.cpp"

#pragma HLS PIPELINE II=1
 T acc=0;
  VITIS_LOOP_6_1: for(int i=0;i<8;i++) acc += a[i]*w[i];
  y=acc;
}
