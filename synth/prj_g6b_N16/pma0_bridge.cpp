...
void pma0_float(
    ...
    x_feat_t x_feat_ap[16*14];
    nnet::convert_data<float, x_feat_t, 16*14>(x_feat, x_feat_ap);
    mask_add_t mask_add_ap[16*32];
    nnet::convert_data<float, mask_add_t, 16*32>(mask_add, mask_add_ap);
...
void pma0_double(
    ...
    x_feat_t x_feat_ap[16*14];
    nnet::convert_data<double, x_feat_t, 16*14>(x_feat, x_feat_ap);
    mask_add_t mask_add_ap[16*32];
    nnet::convert_data<double, mask_add_t, 16*32>(mask_add, mask_add_ap);
