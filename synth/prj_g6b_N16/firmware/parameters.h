...
struct config5 : nnet::batchnorm_config {
    static const unsigned n_in = 16*128;
    static const unsigned n_filt = 128;
...
struct config21 : nnet::merge_config {
    ...
    static const unsigned n_elem1 = 16*32;
    static const unsigned n_elem2 = 16*32;
    static const unsigned reuse_factor = 1;
};
...
unsigned config29_tpose_inp0_from_shape[3] = {16, 8, 4};
unsigned config29_tpose_inp0_to_shape[3] = {8, 4, 16};
...
unsigned config29_tpose_inp1_from_shape[3] = {16, 8, 16};
unsigned config29_tpose_inp1_to_shape[3] = {8, 16, 16};
