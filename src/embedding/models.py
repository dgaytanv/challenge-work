...
# --- SUBMISSION ALIAS (scaffold for submission-deepsets-meanpt) ------------------------------------
# eval.py constructs TransformerEncoder(...) and passes NO keyword arguments, so every
# option must be a constructor default. DeepSetsEncoder takes the same signature and forward contract.
AttentionTransformerEncoder = TransformerEncoder
TransformerEncoder = DeepSetsEncoder
